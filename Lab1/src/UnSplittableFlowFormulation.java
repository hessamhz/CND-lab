...
public class UnSplittableFlowFormulation implements IAlgorithm {
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters,
		...
		op.addDecisionVariable("x_lkc", true, new int[] { D, E }, 0, 1); // name, isInteger, size , minValue, maxValue
		// I added this vector to the code I'm not sure if it was the intended way to
		// solve it but I'm pretty sure that it works and the logic behind it is correct
		// I had dig up the source code to find this method
		...
		netPlan.setRoutingFromDemandLinkCarriedTraffic(x_lkc, true, false, demands,
